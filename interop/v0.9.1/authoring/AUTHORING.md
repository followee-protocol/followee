# AUTHORING subset — Followee v0.9.1 external interoperability

This directory — `authoring/` and nothing outside it — is the complete
material a fresh, independent implementation session may receive for the
Followee v0.9.1 Milestone 6 interoperability experiment. It is
deliberately self-contained: a session seeded with exactly these files
has everything it needs to implement the protocol from the specification
and to produce comparable outputs, and nothing that could leak another
...
| Path | What it is |
| --- | --- |
| `specification/Followee-Specification.md` | The pinned normative specification, v0.9.1. SHA-256 `1c1a20c639aaf90b1bfc54b5e9ea72c49f680566ba9b12ad10615412ece3cd71`. This document alone is normative. |
